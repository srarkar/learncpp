...
Global Random Variables
    Steps for using a global random variable, rather than copying the same value across multiple values.
    ...
    This is one of the few cases a non-const global variable is reasonable to use.
*/
